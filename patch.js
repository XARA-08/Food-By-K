/* ═══════════════════════════════════════════════════════════════
   Food By K — patch.js  (v5 — DEFINITIVE)
   - Realtime sync: admin changes reflect on customer site instantly
   - Orders: addToBasket + toast work correctly for Supabase items
   - Architecture: ITEMS seeded during loadMenu, not on click
   ═══════════════════════════════════════════════════════════════ */
(function () {
  'use strict';
  ...
  function subscribeRealtime() {
    ...
    sb.channel('fbk-hours')
      .on('postgres_changes',{ event:'*', schema:'public', table:'trading_hours' },
        function(){ debounce('hours', loadHours, 300); }).subscribe();
  ...
  /* ── Admin logo tap ──────────────────────────────────────── */
  function patchLogoTapImpl() { patchLogoTap(); }
